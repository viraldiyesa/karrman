...
### Setting The file ###
# Reading File
print('----Welcome to CG6 Quick Review Software----')
# input_data = input('Input Data? (y/n) : ')

# if input_data == 'y':
#     file = input('Input Nama file anda (.txt) : ')
# elif input_data =='n':
#     print('Software akan mencoba file dasar!')
#     file = 'E:/Kerjaan/Bisnis/Geofisika/Software PSDG/Data/CG6/23-03-21.txt'
# else:
#     print('Ah bego lu! Yaudah deh software akan mencoba file dasar!')
#     file = 'E:/Kerjaan/Bisnis/Geofisika/Software PSDG/Python File/CG6-26-03-21-ENDUT.txt'

file = 'E:/Kerjaan/Bisnis/Geofisika/Software PSDG/Data/Newest Format/Raw Data Format/CG6_1/CG6-23-03-21-ENDUT.txt'

skip_rows = input('Input Skip Rows : ')

df = pd.read_table(file, skiprows = int(skip_rows), delim_whitespace = True)
...
gmt = int(input('Input GMT : '))

for i in np.arange(len(df.index)):
    df['DetTime'][i] = df['DetTime'][i].replace(hour = df['DetTime'][i].hour + gmt)
print(df['DetTime'])
